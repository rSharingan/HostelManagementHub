...
import { Menu, X, LogOut, Settings, BarChart3, Users, Home, DollarSign, Wrench, ClipboardList, ClipboardCheck, Globe } from 'lucide-react'
...
const navigationItems = [
  ...
  { label: 'Consultancy', icon: Globe, href: '/consultancy', roles: [ROLES.ADMIN, ROLES.WARDEN, ROLES.CARETAKER, ROLES.STUDENT] },
